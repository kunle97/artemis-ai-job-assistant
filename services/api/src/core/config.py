...
class Settings(BaseSettings):
    ...
    automation_use_snapshots_for_run: bool | None = None
    automation_snapshot_s3_key_prefix: str = "automation/snapshots"
    automation_max_concurrent_sessions: int = 4
    automation_max_concurrent_sessions_per_user: int = 4
